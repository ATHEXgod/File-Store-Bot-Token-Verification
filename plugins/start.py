...
async def start_command(client: Client, message: Message):
    ...
    if len(message.text) > 7:
        for i in range(1):
            ...
            notification_msg = await message.reply(f"<b>his file will be  deleted in  {SECONDS // 7200} minutes. Please save or forward it to your saved messages before it gets deleted.</b>")
